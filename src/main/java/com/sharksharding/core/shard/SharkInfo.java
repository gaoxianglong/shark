...
public class SharkInfo {
	private static SharkInfo shardInfo;
	...
	public static void setShardInfo(SharkInfo shardInfo) {
		SharkInfo.shardInfo = shardInfo;
	}

	static {
		shardInfo = new SharkInfo();
	}

	private SharkInfo() {
	}

	public static SharkInfo getShardInfo() {
		return shardInfo;
	}
}